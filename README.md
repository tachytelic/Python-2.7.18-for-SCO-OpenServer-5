...
The full install is ~30 MB packaged. Grab `python-2.7.18-sco.tar.gz`
from the **Releases** page, copy it to your SCO box, and untar:

```sh
# scp the tarball to the SCO machine, then on SCO:
gunzip -c python-2.7.18-sco.tar.gz | tar xf -
...
```
prebuilt/
  python-2.7.18-sco.tar.gz   30 MB install tarball  ← released as asset, see Releases
